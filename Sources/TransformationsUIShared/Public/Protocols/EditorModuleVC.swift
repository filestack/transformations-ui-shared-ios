...
public protocol EditorModuleVC: UIViewController {
    ...
    /// Returns the current `DiscardApplyToolbar` delegate used by the editor.
    var discardApplyDelegate: DiscardApplyToolbarDelegate? { get set }
}
...
extension EditorModuleVC {
    ...
    public func willUpdateImageView(imageView: CIImageView) { /* NO-OP */ }
    public func didUpdateImageView(imageView: CIImageView) { /* NO-OP */ }
}
